...
class CoSection2 extends StatefulWidget {
  CoSection2({super.key});
  String? value;
  ...
  @override
  State<CoSection2> createState() => _CoSection2State();
}

class _CoSection2State extends State<CoSection2> {
  @override
                    ...
                    child: GestureDetector(
                      onTap: () async {
                        try {
                          ...
                          if (widget.firstName.text != '' &&
                              ...
                              widget.phoneNo.text != '') {
                                 final Response response = await Dio(BaseOptions(
                                    baseUrl:
                                        "https://gi-api-t9k2.onrender.com"))
                                .post(
                              '/gi/sendmail',
                              data: {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Enter all required Fields'),action: SnackBarAction(label: 'ok', onPressed: (){}),));
                          }
                        } catch (e) {
                          showDialog(
                              context: context,
