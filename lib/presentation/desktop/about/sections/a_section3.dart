...
class ASection3 extends StatelessWidget {
  const ASection3({super.key});
      ...
      child: Column(
        ...
        children: [
          const AutoSizeText(
            ...
            // maxLines: 1,
            style: TextStyle(
                color: Color.fromARGB(255, 16, 112, 176), fontSize: 60),
          ),
          const Divider(),
          const AutoSizeText(
            ...
            // maxLines: 1,
            style:
                TextStyle(color: Color.fromARGB(255, 0, 6, 10), fontSize: 30),
          ),
          const AutoSizeText(
            'Our Approach:',
            stepGranularity: 6,
          ...
          Row(
            ...
            children: [
              const AutoSizeText(
                ...
                // maxLines: 1,
                style: TextStyle(
                    color: Color.fromARGB(255, 0, 6, 10), fontSize: 30),
              ),
              SizedBox(
                width:size.width*.6,
