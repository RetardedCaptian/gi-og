...
class MSSection5 extends StatefulWidget {
  const MSSection5({super.key});

  @override
  State<MSSection5> createState() => _MSSection5State();
}

class _MSSection5State extends State<MSSection5> {
  @override
      ...
      children: [
        ...
        SizedBox(
          ...
          child: const AutoSizeText(
            ...
            // maxLines: 1,
            style: TextStyle(
                color: Color.fromARGB(255, 103, 103, 103), fontSize: 15),
          ),
        ),
        SizedBox(
          height: size.height * .04,
